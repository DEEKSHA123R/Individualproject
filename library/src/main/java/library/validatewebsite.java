...
public class validatewebsite {
	...
	@Test(priority = 1)
	public void ValiadteHome() throws InterruptedException {
	...
	@Test(priority = 2)
	public void ValidateLoginandRegisterPage() throws InterruptedException {
		...
		RegisterPageForm.findElement(By.id("email")).sendKeys("shettyd963@gmail.com");
		RegisterPageForm.findElement(By.id("pass")).sendKeys("Deeksha12");
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
...
//				 driver.manage().timeouts().implicitlyWait(5000,TimeUnit.SECONDS);
		...
		LoginPageForm.findElement(By.id("e-mail")).sendKeys("Shettyd@gmail.com");
		...
		driver.findElement(By.xpath("/html/body/div/div[2]/div/form[1]/input[1]")).sendKeys("shettyd963@gmail.com");
...
//				 driver.manage().timeouts().implicitlyWait(20000,TimeUnit.SECONDS);
	...
	@Test(priority = 3)
	public void ValidateWebsiteAddCart() throws InterruptedException {
		// Add cart here
		driver.manage().timeouts().implicitlyWait(200, TimeUnit.SECONDS);
		WebElement LogoutButton = driver.findElement(By.xpath("/html/body/header/div/div[1]/a"));
		driver.manage().timeouts().implicitlyWait(200, TimeUnit.SECONDS);
		LogoutButton.click();
	...
	@Test(priority = 4)
	public void ValidateWebsiteAdminPages() throws InterruptedException {
		...
		driver.findElement(By.xpath("/html/body/div/div/div[2]/div/form/input[1]")).sendKeys("shettyd963@gmail.com");
...
//						String SuccessMessages1=AdminPageForm.findElement(By.id("LoginMessage")).findElement(By.tagName("h6")).getText();
//						String AdminSucessMessages=SuccessMessages1.getText().trim();
//						String AdminSucessErrorMessage="Paasword and email not matching";
//						Assert.assertEquals(AdminSucessMessages,AdminSucessErrorMessage);
//						 driver.manage().timeouts().implicitlyWait(5000,TimeUnit.SECONDS);

		// validating the Admin Page details
